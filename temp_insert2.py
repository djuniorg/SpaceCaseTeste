...
entries={
'index.html':('    </section>\n\n    <section class="hero-produto">', '''    </section>\n\n    <section class="section">
    ...
    </section>\n\n    <section class="hero-produto">'''),
'caderno.html':('    </section>\n\n    <section class="cta">', '''    </section>\n\n    <section class="section">
...
for name,(marker,snippet) in entries.items():
    path=base/name
